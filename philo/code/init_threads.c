...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/01/26 22:49:34 by smoumni           #+#    #+#             */
/*   Updated: 2024/01/27 00:42:03 by smoumni          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_data	*init_threads(t_philo *philos, t_fork *forks, t_eve *eve, char **av)
{
	t_data			*arr;
	int				i;
	...
	while (++i < ft_atoi(av[0]))
	{
		...
		arr[i].eve = &eve[i];
		arr[i].print_mutex = eve[i].print_mutex;
